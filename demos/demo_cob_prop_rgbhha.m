...
% Read an input image
I = imread(fullfile(cob_root, 'demos','RGB.png'));
D = imread(fullfile(cob_root, 'demos','HHA.png'));

% Compute the proposals
[proposals_cob, ucm2_cob, times] = im2prop(cat(3,I,D));
...
% Candidates in rank position 1 and 3
id1 = 1; id2 = 3;
